...
function ensureCondStack(stack: Stack) {
...
export const elseifOp = (stack: Stack) => {
  const condition = stack.pop();
  const block = stack.pop();
  const condStack = ensureCondStack(stack);
...
export const elseOp = (stack: Stack) => {
  const block = stack.pop();
  const condStack = ensureCondStack(stack);
...
export const dropWhen = (stack: Stack) => {
  const condition = stack.pop();
...
export const timesOp = (stack: Stack) => {
  let top = stack.pop();
...
export const breakOp = (stack: Stack) => {
...
export const whileOp = (stack: Stack) => {
...
export const untilOp = (stack: Stack) => {
  const bodyBlock = stack.pop();
  const condBlock = stack.pop();
