...
function isUnicodeOperator(ch: string): boolean {
...
export function lex(source: string): Token[] {
  ...
  function addToken(type: TokenTypeValue, value: unknown, startLine: number, startCol: number): void {
   ...
   */
  function canStartNegativeNumber(): boolean {
  ...
  function readNumber(startLine: number, startCol: number): void {
    let num = "";
  ...
  function readDynamicOperator(numStr: string, startLine: number, startCol: number): void {
  ...
  function readString(quote: string, startLine: number, startCol: number): void {
  ...
  function readIdentifierOrKeyword(startLine: number, startCol: number): void {
    let name = "";
  ...
  function readOperator(startLine: number, startCol: number): void {
  ...
  function readStars(startLine: number, startCol: number): void {
    let stars = "";
  ...
  function readComment(startLine: number, startCol: number): void {
    advance(); // skip first /
    advance(); // skip second /
    let text = "";
  ...
  function readHashComment(startLine: number, startCol: number): void {
    advance(); // skip #
    let text = "";
    // Skip leading space if present
    if (pos < source.length && current() === " ") {
  ...
  function readColon(startLine: number, startCol: number): void {
    advance(); // skip first :
