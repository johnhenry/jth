 ...
 */
function generateJSObject(properties: any[]): string {
 ...
 */
function generateDefinition(name: string, bodyExprs: any[]): string {
 ...
 */
function generateValueDefinition(name: string, bodyExprs: any[]): string {
  const jsName = sanitize(name);
